/** Illustrations for the product tour — readable in-app and in social screenshots. */

const TILES = [
  { x: 16, y: 28, label: "Trip" },
  { x: 112, y: 28, label: "Fetch" },
  { x: 208, y: 28, label: "Send" },
  { x: 16, y: 128, label: "Shops" },
  { x: 112, y: 128, label: "Reserve" },
  { x: 208, y: 128, label: "Safety" },
] as const;

/** Trip · Fetch · Send · Shops · Reserve · Safety */
      ...
      {TILES.map((t) => (
        <g key={t.label}>
          <rect
            ...
            strokeWidth="2"
          />
          <circle cx={t.x + 44} cy={t.y + 34} r="13" fill="#000" />
          <text
            x={t.x + 44}
            y={t.y + 68}
            textAnchor="middle"
  ...
  return (
    <svg viewBox="0 0 320 280" className="h-auto w-full" aria-hidden>
      ...
      <text
        ...
        fontWeight="600"
      >
        A driver goes for you
      </text>
      <rect x="36" y="128" width="118" height="112" rx="18" fill="#000" />
      <text
        x="95"
        y="178"
        textAnchor="middle"
...
/** Launch date + driver keep 90% — built for social screenshots. */
export function ArtLaunch() {
  return (
    <svg viewBox="0 0 320 280" className="h-auto w-full" aria-hidden>
      <rect width="320" height="280" rx="32" fill="#111" />
      <rect x="48" y="36" width="224" height="88" rx="18" fill="#fff" />
      <text
        x="160"
        y="72"
        textAnchor="middle"
...
export function ArtWearing() {
  return (
    <svg viewBox="0 0 320 280" className="h-auto w-full" aria-hidden>
      ...
      <path d="M110 200c8-44 28-64 50-64s42 20 50 64" fill="#1a1a1a" />
      <rect
        x="56"
        y="168"
        width="208"
