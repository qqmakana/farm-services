/** Haversine distance in km — nearest-driver matching like Uber. */
...
export function etaMinutes(distanceKilometers: number) {
  return Math.max(3, Math.round((distanceKilometers / 30) * 60));
}
